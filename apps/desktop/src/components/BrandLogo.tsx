...
export default function BrandLogo({ theme, width = 32, height = 32 }: BrandLogoProps) {
  const isDark = theme === "dark";
  
  // Natively adapt colors using SVG logic
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Background shape precisely cut out (transparent outside) */}
      <circle cx="50" cy="50" r="46" fill={circleColor} filter="url(#shadow)" />
      
      {/* Abstract document/check shape inside */}
      <path 
      ...
      {/* Decorative dots representing OMR bubbles */}
