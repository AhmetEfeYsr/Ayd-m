    ...
    >
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28, fontSize: 15, lineHeight: 1.7, color: "#d4d4d8" }}>
          <section>
            <p>
              Aydım platformuna (web sitesi, masaüstü uygulaması ve API servisleri dahil) hoş geldiniz.
          ...
          <section>
            ...
            <p>
              Aydım, eğitim kurumlarına yönelik bulut tabanlı bir yönetim, Tauri tabanlı optik okuma (OMR),
          ...
          <section>
            ...
            <p>
              ...
              Hesapların yetkisiz üçüncü şahıslar tarafından kullanılması durumunda doğacak zararlardan Aydım sorumlu tutulamaz.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Aydım, veli yoklama ve bildirim gönderimleri için Netgsm SMS ve WhatsApp Cloud API entegrasyonları sunar.
              Gönderim maliyetleri doğrudan kurumun kendi operatör anlaşması üzerinden karşılanır.
              Aydım, bu üçüncü taraf servislerin (Netgsm, WhatsApp/Meta) kesintilerinden, geçici servis dışı kalmalarından
          ...
          <section>
            ...
            <p>
              Aydım, platformun kesintisiz ve hatasız çalışması için gerekli teknik hassasiyeti göstermektedir.
              ...
              aksamalardan Aydım hukuken sorumlu değildir.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Aydım, bu kullanım koşullarını dilediği zaman güncelleme hakkını saklı tutar.
